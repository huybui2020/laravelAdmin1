                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Post Title</th><th>Post Image</th><th>Category</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($posts as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->post_title }}</td><td><img src="{{ asset('uploads/posts/' .$item->post_image) }}" alt="{{$item->post_title}}" style="width: 60px; height: 40px; border: 1px solid grey; "></td>
